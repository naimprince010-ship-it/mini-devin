...
def upgrade() -> None:
    ...
    # Railway / legacy DBs may already have these tables (e.g. SQLAlchemy create_all) with an
    # empty alembic_version — skip creates so this revision can stamp without DuplicateTable.
    ...
    if "sessions" not in tables:
        op.create_table(
            ...
            sa.Column(
                "status",
                sa.Enum("IDLE", "RUNNING", "ERROR", "TERMINATED", name="sessionstatus"),
                nullable=False,
            ),
