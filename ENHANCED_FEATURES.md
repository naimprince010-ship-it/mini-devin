# Enhanced Plodder Features

This document describes the enhanced features that make Plodder comparable to Devin AI.
...
```bash
LOG_LEVEL=DEBUG poetry run plodder run "your task"
```

## 🎉 Next Steps

These enhanced features bring Plodder much closer to Devin's capabilities:
